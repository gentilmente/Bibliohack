...
class TranslationService {
  ...
  init(config, callback) {
    ...
    console.log(
      "Using translations for language",
      config.language || "en",
      "with fallback language en"
    );
    ...
    i18next.use(Backend).init(i18nConfig, (error, t) => {
      if (error) {
...
export { translationService as default, handlebarsHelper };
